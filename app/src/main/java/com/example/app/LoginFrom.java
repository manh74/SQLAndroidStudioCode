...
public class LoginFrom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn = findViewById(R.id.btLogin);
            ...
            public void onClick(View v) {
                ...
                for (int i=0;i<acc.size();i++){
                    if(acc.get(i).getUserName().equals(userName) && acc.get(i).getPassWord().equals(passWord)){
                        ...
                        Log.d("Dang nhap",acc.get(i).getUserName()+acc.get(i).getPassWord()+userName+passWord);
                    }
                }
        ...
        Button btdk =findViewById(R.id.btRegist);
