...
public class SQL extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String ROW1 = "INSERT INTO popular" + " Values (1,'Sen đá cổ','senda01','5.0','4.5 minis', 'Free Delivery','75.000','Extra special');";
        db.execSQL(ROW1);

        String ROW2 = "INSERT INTO popular"  + " Values (2,'Sen đá mọng nước','senda02','5.0','4.5 minis', 'Free Delivery','50.000','Extra special');";
        db.execSQL(ROW2);

        String ROW3 = "INSERT INTO popular"   + "  Values (3,'Sen đá mini','senda03','5.0','4.5 minis', 'Free Delivery','80.000','Extra special');";
        db.execSQL(ROW3);
        // insert du lieu vao bang new product
        String R1 = "INSERT INTO newproduct" + " Values (1,'Sen đá đô la trắng','senda04','5.0','4.5 minis', 'Free Delivery','150.000','Extra special');";
        db.execSQL(R1);

        String R2 = "INSERT INTO newproduct"  + " Values (2,'Sen đá đô la hồng','senda05','5.0','4.5 minis', 'Free Delivery','150.000','Extra special');";
        db.execSQL(R2);

        String R3 = "INSERT INTO newproduct"   + " Values (3,'Sen đá hàm cá mập','senda06','5.0','4.5 minis', 'Free Delivery','150','Extra special');";
        db.execSQL(R3);

        String R4 = "INSERT INTO newproduct"   + " Values (4,'Sen đá nâu','senda07','5.0','4.5 minis', 'Free Delivery','150','Extra special');";
        db.execSQL(R4);

        String R5 = "INSERT INTO newproduct"   + " Values (5,'Sen đá phật bà','senda07','5.0','4.5 minis', 'Free Delivery','150','Extra special');";
        db.execSQL(R5);
